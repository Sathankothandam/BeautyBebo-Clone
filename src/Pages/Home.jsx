  ...
  return (
    <div className='Home_main'>
        ...
        <div className='slide_prod'>
            ...
            <div>
                <img src="https://www.beautybebo.com/pub/media/catalog/product/cache/37253e89591b79b38c00254331932999/e/f/efbafe2nywow000083__1_.jpg" alt="" />
                <p>Hair Oil</p>
                <h5>₹250</h5>
                <button>Add To Cart</button>
            </div>
            <div>
                <img src="https://www.beautybebo.com/pub/media/catalog/product/cache/37253e89591b79b38c00254331932999/f/d/fd794d08904304373124.jpg" alt="" />
                <p>Peel of Face Mask</p>
                <h5>₹321</h5>
                <button>Add To Cart</button>
            </div>
            <div>
                <img src="https://www.beautybebo.com/pub/media/catalog/product/cache/37253e89591b79b38c00254331932999/7/b/7ba61598904352001284_1.jpg" alt="" />
                <p>Biotique Treatment Oil</p>
                <h5>₹299</h5>
                <button>Add To Cart</button>
            </div>
        </div>
        ...
        <div className='slide_prod'>
            ...
            <div>
                <img src="https://www.beautybebo.com/pub/media/catalog/product/cache/37253e89591b79b38c00254331932999/i/m/image1_600x.jpg" alt="" />
                <p>Hair Oil</p>
                <h5>₹250</h5>
                <button>Add To Cart</button>
            </div>
            <div>
                <img src="https://www.beautybebo.com/pub/media/catalog/product/cache/37253e89591b79b38c00254331932999/3/6/3699c478906105612174-2.jpg" alt="" />
                <p>Peel of Face Mask</p>
                <h5>₹321</h5>
                <button>Add To Cart</button>
            </div>
            <div>
                <img src="https://www.beautybebo.com/pub/media/catalog/product/cache/37253e89591b79b38c00254331932999/8/9/8904304651284_1.jpg" alt="" />
                <p>Biotique Treatment Oil</p>
                <h5>₹299</h5>
                <button>Add To Cart</button>
            </div>
